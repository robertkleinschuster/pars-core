...
use Mezzio\Session\Cache\Exception\InvalidArgumentException;
...
class ParsSessionPersistence implements SessionPersistenceInterface
{
    ...
    public function initializeSessionFromRequest(ServerRequestInterface $request): SessionInterface
    {
        ...
        return new ParsSession($sessionData, $id);
    }
